...
: 크롤링을 이용한 **역대 로또번호 데이터** 를 추출하여 **가장 많이 뽑힌 번호** 10개를 조합한 로또 번호 생성기
...
<img src="./image/flowchart.jpg" alt="drawing" width="600"/>
...
- 1개 맞는 결과로  낙첨되었지만 첫 시도인만큼 1개 맞는 결과도 의미있다고
...
=======
>>>>>>> 1d6322d761cc36e9145dabd066b7ead1013c409b
