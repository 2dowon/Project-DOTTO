...
<img src="./image/dotto_v2.gif" alt="drawing" width="600"/>
...
- __2020년 11월 13일 금요일에 랜덤 로또 번호 3장, 데이터 기반 로또 번호 3장 총 6장 구매 후 14일에 로또 당첨번호 확인 결과, 역대 로또 데이터 분석을 기반으로 한 10개의 번호 중 **40번** 만 유일하게 나왔다. 아래 결과에서 볼 수 있듯이 랜덤으로 추출한 번호나 데이터를 기반으로 추출한 번호나 결과에는 큰 차이가 없음을 확인할 수 있다.
...
<br>
<img src="./image/lotto.png" alt="drawing" width="300"/>

</br>
</br>


<img src="./image/lotto3.png" alt="drawing" width="300"/>
...
### 데이터 기반 로또 번호 추출
<br>
<img src="./image/lotto2.png" alt="drawing" width="300"/>
